...
exports.ReferenceInputView = function (_a) {
    ...
    var finalMeta = warning
        ? __assign({}, meta, { error: warning }) : meta;
    return react_1.cloneElement(children, __assign({ allowEmpty: allowEmpty,
        classes: classes,
        className: className,
        input: input,
