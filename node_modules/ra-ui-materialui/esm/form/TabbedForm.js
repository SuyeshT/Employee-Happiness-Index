...
import { escapePath, useTranslate, useInitializeFormWithRecord, sanitizeEmptyValues, } from 'ra-core';
...
var TabbedForm = function (_a) {
    ...
    return (React.createElement(Form, __assign({ key: props.version, initialValues: finalInitialValues, onSubmit: submit, mutators: __assign({}, arrayMutators), setRedirect: setRedirect, keepDirtyOnReinitialize: true, subscription: defaultSubscription }, props, { render: function (formProps) { return (React.createElement(TabbedFormView, __assign({ classes: classes, saving: formProps.submitting || saving, translate: translate }, props, formProps))); } })));
};
