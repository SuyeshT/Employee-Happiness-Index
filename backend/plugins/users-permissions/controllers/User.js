...
module.exports = {
  ...
  count: async (ctx, next, { populate } = {}) => {
    return strapi.plugins['users-permissions'].services.user.count(ctx.query, populate);
  },
  ...
  find: async (ctx, next, { populate } = {}) => {
    ctx.set('Content-Range', await strapi.plugins['users-permissions'].services.user.count());
